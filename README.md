...
|Monday February 21| Finish up GSP background, Identifying condition or experimentally-specific prototypical cells with Meld, Differential Abundance Analysis with Cydar | [[Cydar](https://www.nature.com/articles/nmeth.4295)] | | [[cydar](https://www.bioconductor.org/packages/release/bioc/html/cydar.html)] |
|Wednesday February 23, **Homework 1 is due by 11:59pm eastern time**| Differential Abundance Day 2 with Milo and Contrastive PCA|
